...
def adicionar():
    ...
    with st.form(key="include_despesas"):
        ...
        input_categoria = st.selectbox("Selecione a categoria da sua Despesa",["Água","Luz","Escola","Telefone","Gás","Aluguel","Internet","Gasolina","Alimentação","Festas","Viagens","Investimentos","Outros"])
